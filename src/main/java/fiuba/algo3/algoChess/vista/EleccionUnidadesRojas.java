...
public class EleccionUnidadesRojas extends VBox {
	...
	public EleccionUnidadesRojas() {
		...
		this.getChildren().add(this.publicarUnidad(toggleGroup,new ImageView(new Image("imagenes/CatapultaRojo.png",30,30,true,true)),"Catapulta","$5 - 50 - 20"));
		
		this.getChildren().add(this.publicarUnidad(toggleGroup,new ImageView(new Image("imagenes/CuranderoRojo.png",30,30,true,true)),"Curandero","$2 - 75 - 15"));

		this.getChildren().add(this.publicarUnidad(toggleGroup, new ImageView(new Image("imagenes/JineteRojo.png",30,30,true,true)), "Jinete", "$3 - 100 - 5/15"));

		this.getChildren().add(this.publicarUnidad(toggleGroup, new ImageView(new Image("imagenes/SoldadoRojo.png",30,30,true,true)), "Soldado", "$1 - 100 - 10"));
