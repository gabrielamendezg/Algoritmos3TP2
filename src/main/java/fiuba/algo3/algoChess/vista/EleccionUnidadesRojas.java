...
public class EleccionUnidadesRojas extends VBox {
	...
	public EleccionUnidadesRojas() {
		...
		catapulta.setGraphic(new ImageView(new Image(getClass().getResource("imagenes/CatapultaRojo.png").toExternalForm(),30,30,true,true)));
		...
		curandero.setGraphic(new ImageView(new Image(getClass().getResource("imagenes/CuranderoRojo.png").toExternalForm(),30,30,true,true)));
		...
		jinete.setGraphic(new ImageView(new Image(getClass().getResource("imagenes/JineteRojo.png").toExternalForm(),30,30,true,true)));
		...
		soldado.setGraphic(new ImageView(new Image(getClass().getResource("imagenes/SoldadoRojo.png").toExternalForm(),30,30,true,true)));
