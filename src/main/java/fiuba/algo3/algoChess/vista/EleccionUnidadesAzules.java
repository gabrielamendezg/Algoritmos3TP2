...
public class EleccionUnidadesAzules extends VBox {
	...
	public EleccionUnidadesAzules() {
		...
		this.getChildren().add(this.publicarUnidad(toggleGroup,new ImageView(new Image("imagenes/CatapultaAzul.png",30,30,true,true)),"Catapulta","$5 - 50 - 20"));
		
		this.getChildren().add(this.publicarUnidad(toggleGroup,new ImageView(new Image("imagenes/CuranderoAzul.png",30,30,true,true)),"Curandero","$2 - 75 - 15"));

		this.getChildren().add(this.publicarUnidad(toggleGroup, new ImageView(new Image("imagenes/JineteAzul.png",30,30,true,true)), "Jinete", "$3 - 100 - 5/15"));

		this.getChildren().add(this.publicarUnidad(toggleGroup, new ImageView(new Image("imagenes/SoldadoAzul.png",30,30,true,true)), "Soldado", "$1 - 100 - 10"));
