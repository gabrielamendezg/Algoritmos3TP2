...
public class CatapultaTest {
    ...
    public void catapultaAtacaAlAtacableYALosAtacablesContiguasTest(){
       /* JugadorA jugador = new JugadorA();
        ...
        soldado[1].setPosicion(new Posicion(8, 9));soldado[6].setPosicion(new Posicion(12, 9));
        soldado[2].setPosicion(new Posicion(9, 10));soldado[7].setPosicion(new Posicion(11, 10));
        soldado[3].setPosicion(new Posicion(10, 11));soldado[8].setPosicion(new Posicion(9, 12));
        soldado[4].setPosicion(new Posicion(11, 12));soldado[9].setPosicion(new Posicion(8, 13));
        soldado[5].setPosicion(new Posicion(12, 13));soldado[10].setPosicion(new Posicion(10, 9));

        soldado[11].setPosicion(new Posicion(10, 10));soldado[16].setPosicion(new Posicion(11, 11));
        soldado[12].setPosicion(new Posicion(10, 12));soldado[17].setPosicion(new Posicion(12, 11));
        soldado[13].setPosicion(new Posicion(10, 13));soldado[18].setPosicion(new Posicion(8, 15));
        soldado[14].setPosicion(new Posicion(8, 11));soldado[19].setPosicion(new Posicion(9, 15));
        soldado[15].setPosicion(new Posicion(9, 11));soldado[20].setPosicion(new Posicion(10, 15));
        ...
        catapulta.atacarAtacable(new JugadorA(), soldado[1], atacables);
        assertEquals(soldado[1].obtenerVida(), 80);*/
    }
}
